...
ALTER TABLE public.publication_houses DISABLE TRIGGER ALL;
...
ALTER TABLE public.publication_houses ENABLE TRIGGER ALL;
...
ALTER TABLE public.book_authors DISABLE TRIGGER ALL;
...
ALTER TABLE public.book_authors ENABLE TRIGGER ALL;

--
-- Data for Name: book_characters; Type: TABLE DATA; Schema: public; Owner: -
--

ALTER TABLE public.book_characters DISABLE TRIGGER ALL;



ALTER TABLE public.book_characters ENABLE TRIGGER ALL;

--
-- Data for Name: book_character_appearances; Type: TABLE DATA; Schema: public; Owner: -
--

ALTER TABLE public.book_character_appearances DISABLE TRIGGER ALL;



ALTER TABLE public.book_character_appearances ENABLE TRIGGER ALL;

--
-- Data for Name: moderator_accounts; Type: TABLE DATA; Schema: public; Owner: -
--

ALTER TABLE public.moderator_accounts DISABLE TRIGGER ALL;

INSERT INTO public.moderator_accounts VALUES (18);
INSERT INTO public.moderator_accounts VALUES (20);


ALTER TABLE public.moderator_accounts ENABLE TRIGGER ALL;

--
-- Data for Name: user_accounts; Type: TABLE DATA; Schema: public; Owner: -
--

ALTER TABLE public.user_accounts DISABLE TRIGGER ALL;
...
ALTER TABLE public.user_accounts ENABLE TRIGGER ALL;

--
-- Data for Name: book_suggestions; Type: TABLE DATA; Schema: public; Owner: -
--

ALTER TABLE public.book_suggestions DISABLE TRIGGER ALL;



ALTER TABLE public.book_suggestions ENABLE TRIGGER ALL;
...
ALTER TABLE public.user_books DISABLE TRIGGER ALL;
...
ALTER TABLE public.user_books ENABLE TRIGGER ALL;
